...
```bash
git clone https://github.com/kdandy/avocado
```
...
- Open the [demo page](https://avocado-dandy.netlify.app/)
- Open the [source code](http://github.com/kdandy/avocado)
...
avocado is created by <a href="https://kdandy.com">dandy</a>.

## Bugs and Issues

Have a bug or an issue with this template? [Open a new issue](https://github.com/kdandy/avocado/issues/new) here on GitHub.
